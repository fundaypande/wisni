...
if(!empty($_POST["add_record"])) {
	$sql = "INSERT INTO tpenyakit ( id_penyakit, nama, keterangan, id_tanaman ) VALUES ( NULL, :nama, :keterangan, :tanaman)";
...
<div style="margin:20px 0px;text-align:right;"><a href="penyakit.php" class="button_link">Back to List</a></div>
<div class="frm-add">
